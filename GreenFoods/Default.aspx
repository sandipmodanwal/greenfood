<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GreenFoods.Default" %>
				...
				<div class="container">
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header w3l_logo">
							...
							<h1><a href="Default.aspx">GreenFood<span>Best Food Collection</span></a></h1>
						</div> 
				...
				<div class="agileits_search">
					<form action="#" method="post">
						...
						<select id="agileinfo_search" name="agileinfo_search" required="">
							...
							<option value="navs">Ghazipur</option>
							<option value="quotes">Varanasi</option>
							<option value="videos">Raebareli</option>
							<option value="news">Lucknow</option>
							<option value="notices">Darbhanga</option>
							<option value="all">Bhadohi</option>
						</select>
			...
			<div class="dealsrow">
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						<h4>FREE DELIVERY</h4>
						<p>GreenFood provide free delevery service then which item above 300 rupees </p>
					</div> 
					<div class="clearfix"> </div>
				</div> 
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						<h4>Party Orders</h4>
						<p>GreenFood provide party order service and take my service at least one time </p>
					</div> 
					<div class="clearfix"> </div>
				</div>
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						...
						<p>GreenFood every member work a shedules and provide quickly service </p>
					</div>
					<div class="clearfix"> </div>
				</div> 
				<div class="col-md-6 col-sm-6 deals-grids">
					...
					<div class="deals-right">
						...
						<p>GreenFood corperate every order of costomer and give fast servise  </p>
					</div>
					<div class="clearfix"> </div>
				</div> 
				<div class="clearfix"> </div>
		...
		<div class="container">
			...
			<div class="spldishes-agileinfo">
				<div class="col-md-3 spldishes-w3left">
					<h5 class="w3ltitle">Grren Specials</h5>
					<p>GreenFood every time give a special offers to between foods and costomers .</p>
				</div> 
				<div class="col-md-9 spldishes-grids">
					<!-- Owl-Carousel -->
					<div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
						<a href="products.aspx" class="item g1">
							<img class="lazyOwl" src="images/g1.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Home Work</h4>
								<span>Moreover, any person belonging to the pain of those who do not </span>
							</div>
						</a>
						<a href="products.aspx" class="item g1">
