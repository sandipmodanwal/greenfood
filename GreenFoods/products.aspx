<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="GreenFoods.products" %>
		...
		<div class="container">
			...
			<div class="col-md-3 rsidebar">
				...
				<div class="related-row">
					...
					<ul>
						<li><a href="products.aspx">Salads </a></li>
						<li><a href="products.aspx">Vegetarian</a></li>
						<li><a href="products.aspx">Dinner</a></li>
						<li><a href="products.aspx">Diet Soup</a></li>
						<li><a href="products.aspx">Sweets</a></li>
						<li><a href="products.aspx">Seasonal</a></li>
						<li><a href="products.aspx">Breakfast</a></li>
						<li><a href="products.aspx">Italian Food</a></li>
						<li><a href="products.aspx">Meals</a></li> 
					</ul>
				</div>
				<div class="related-row">
